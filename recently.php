...
// Query to fetch movie details and sort by date_start_air
$sql = "SELECT * FROM movie_detail WHERE date_start_air > '$current_date' ORDER BY date_start_air ASC";
...
$products_per_page = 9;
$total_products = count($upcoming_shows);
...
$paginated_shows = array_slice($upcoming_shows, $start_index, $products_per_page);
?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <title>CINE EASE - Upcomming Shows</title>
